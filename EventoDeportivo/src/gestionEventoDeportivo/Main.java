	...
	public static void main(String[] args) throws ParticipanteNoValidoException {
		...
		while (!salir) {
			...
			case 1:
				...
				break;
			case 2:
				// Inscribir participante en carrera
				...
				scanner.nextLine(); // Limpiar el buffer
				Participante participante = new Participante(nombreParticipante, apellidoParticipante, edadParticipante,
						tiempoRealizado);
				carrera.inscribirParticipante(participante);
				System.out.println("Participante inscrito: " + participante);
				break;
			case 3:
				// Mostrar ganador de la carrera
			...
			case 4:
				...
				break;
			case 5:
				// Añadir jugador a equipo de fútbol
				...
				break;
			case 6:
				// Asignar puntos a equipo de fútbol
				System.out.print("Nombre del equipo: ");
				...
				break;
			case 7:
				// Mostrar ganador del torneo de fútbol
